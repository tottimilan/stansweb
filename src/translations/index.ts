export const translations = {
  es: {
    ...
    contact: {
      ...
      leadForm: {
        ...
        email: 'Tu email',
        mensaje: 'Cuéntanos lo que te ha pasado (mínimo 50 caracteres)',
        mensajeCorto: 'Por favor, escribe al menos 50 caracteres para explicar tu caso',
  ...
  ar: {
    ...
    contact: {
      ...
      leadForm: {
        ...
        mensaje: 'أخبرنا بما حدث لك (50 حرفًا على الأقل)',
        mensajeCorto: 'يرجى كتابة 50 حرفًا على الأقل لشرح قضيتك',
  ...
  en: {
    ...
    contact: {
      ...
      leadForm: {
        ...
        telefono: 'Your phone',
        email: 'Your email',
        mensaje: 'Tell us what happened to you (minimum 50 characters)',
        mensajeCorto: 'Please write at least 50 characters to explain your case',
        nombreRequerido: 'Please enter your full name',
        telefonoRequerido: 'Please enter your phone number',
        emailInvalido: 'Please enter a valid email',
        errorConexion: 'Connection error. Please check your internet and try again',
  ...
  fr: {
    ...
    contact: {
      ...
      leadForm: {
        nombre: 'Votre nom complet',
        telefono: 'Votre téléphone',
        email: 'Votre email',
        mensaje: 'Dites-nous ce qui vous est arrivé (minimum 50 caractères)',
        mensajeCorto: 'Veuillez écrire au moins 50 caractères pour expliquer votre cas',
        nombreRequerido: 'Veuillez entrer votre nom complet',
        telefonoRequerido: 'Veuillez entrer votre numéro de téléphone',
        emailInvalido: 'Veuillez entrer un email valide',
        errorConexion: 'Erreur de connexion. Veuillez vérifier votre internet et réessayer',
