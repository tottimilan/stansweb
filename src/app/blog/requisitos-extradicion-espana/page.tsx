...
import { ArrowLeft, Calendar, Clock, User, Share2, ArrowRight, Phone, AlertTriangle, CheckCircle, FileText, Shield, Scale, FileCheck } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {requisitosSustantivos.map((requisito, index) => (
                    ...
                    >
                      ...
                      <p className="text-black/80 text-sm mb-3" dangerouslySetInnerHTML={{ __html: requisito.descripcion }} />
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-black/80 text-sm" dangerouslySetInnerHTML={{ __html: causa.descripcion }} />
                        </div>
