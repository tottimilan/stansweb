...
import { ArrowLeft, Calendar, Clock, User, Share2, ArrowRight, Phone, AlertTriangle, CheckCircle, FileText, Shield, Scale, Gavel, MapPin } from 'lucide-react';
                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-black/80 text-sm mb-2" dangerouslySetInnerHTML={{ __html: derecho.descripcion }} />
                        </div>
