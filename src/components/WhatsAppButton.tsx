...
export default function WhatsAppButton({ whatsapp = '34XXXXXXXXX' }: Props) {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 bg-gold text-black rounded-full px-3 py-2 sm:px-5 sm:py-3 shadow-soft hover:shadow-xl transition-all duration-300 z-50"
    >
